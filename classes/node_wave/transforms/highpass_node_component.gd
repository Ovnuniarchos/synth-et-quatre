...
class_name HighpassNodeComponent

const NODE_TYPE:String="Highpass"
...
func equals(other:WaveNodeComponent)->bool:
	if (other as HighpassNodeComponent)==null:
		return false
...
func duplicate(container:Reference)->WaveNodeComponent:
	var nc:HighpassNodeComponent=.duplicate(container) as HighpassNodeComponent
	nc.cutoff=cutoff
