...
class_name BandpassNodeComponent

const NODE_TYPE:String="Bandpass"
...
func calculate()->Array:
	...
	NODES.bandpass(output,sz,optr,cutofflo,cutoffhi,steps,
...
func equals(other:WaveNodeComponent)->bool:
	if (other as BandpassNodeComponent)==null:
		return false
...
func duplicate(container:Reference)->WaveNodeComponent:
	var nc:BandpassNodeComponent=.duplicate(container) as BandpassNodeComponent
