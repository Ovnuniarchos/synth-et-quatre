...
func duplicate()->Instrument:
	...
	ni.pre_attack_macros=duplicate_op_macros(pre_attack_macros)
	ni.pre_attack_level_macros=duplicate_op_macros(pre_attack_level_macros)
	ni.attack_macros=duplicate_op_macros(attack_macros)
	ni.pre_decay_macros=duplicate_op_macros(pre_decay_macros)
	ni.pre_decay_level_macros=duplicate_op_macros(pre_decay_level_macros)
...
func copy(from:Instrument,full:bool=false)->void:
	if from.get("TYPE")=="FmInstrument":
		...
		pre_attack_levels=from.pre_attack_levels.duplicate()
		attacks=from.attacks.duplicate()
		pre_decays=from.pre_decays.duplicate()
		pre_decay_levels=from.pre_decay_levels.duplicate()
		...
		pre_attack_macros=duplicate_op_macros(from.pre_attack_macros)
		pre_attack_level_macros=duplicate_op_macros(from.pre_attack_level_macros)
		attack_macros=duplicate_op_macros(from.attack_macros)
		pre_decay_macros=duplicate_op_macros(from.pre_decay_macros)
		pre_decay_level_macros=duplicate_op_macros(from.pre_decay_level_macros)
