...
func _ready()->void:
	for i in 13:
		$Quarter0/OptionButton.add_item("NODE_SAW_Q%d"%[i],i)
		$Quarter1/OptionButton.add_item("NODE_SAW_Q%d"%[i],i)
		$Quarter2/OptionButton.add_item("NODE_SAW_Q%d"%[i],i)
		$Quarter3/OptionButton.add_item("NODE_SAW_Q%d"%[i],i)
