...
enum{
	...
	TOKEN_CMD_CLEAR,TOKEN_CMD_UNSET,TOKEN_CMD_SMOOTH,
...
enum{
	OP_LINE=1000,OP_ALPHA,OP_EASE,OP_HSTEP,OP_VSTEP,OP_SET,OP_CLEAR,OP_UNSET,
	OP_SMOOTH
}
...
const COMMANDS:Dictionary={
	...
	# SMOOTH X0,X1(,SIZE(,CURVE(,ALPHA)))
	OP2CMD[OP_SMOOTH]:[
		null,TOKEN_CMD_SMOOTH,5,[
			TOKEN_CMD_SMOOTH,TOKEN_WHITESPACE,TOKEN_NUMBER,TOKEN_SEPARATOR,TOKEN_NUMBER,
			TOKEN_OPTIONAL,TOKEN_SEPARATOR,TOKEN_NUMBER,
			TOKEN_OPTIONAL,TOKEN_SEPARATOR,TOKEN_NUMBER,
			TOKEN_OPTIONAL,TOKEN_SEPARATOR,TOKEN_NUMBER
		],[TOKEN_CMD_ALPHA,TOKEN_CMD_EASE,TOKEN_CMD_HSTEP,TOKEN_CMD_VSTEP]
