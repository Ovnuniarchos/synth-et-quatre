...
func update_macros(ci:FmInstrument)->void:
	...
	get_node("VBC/PreAtkRate").set_macro(ci.pre_attack_macros[operator])
	get_node("VBC/PreAtkLev").set_macro(ci.pre_attack_level_macros[operator])
	get_node("VBC/Attack").set_macro(ci.attack_macros[operator])
	get_node("VBC/PreDecRate").set_macro(ci.pre_decay_macros[operator])
	get_node("VBC/PreDecLev").set_macro(ci.pre_decay_level_macros[operator])
